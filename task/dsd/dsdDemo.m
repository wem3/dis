...
% studyDir = uigetdir('top study directory'); % <----------actually use this line
...
demo = getSubInfo();
  ...
  stim = initStimulus(demo, pos, coinFile,taskName);
  outputFile = ([demo.subID,'_',stim.task,'_','output','.txt']);
